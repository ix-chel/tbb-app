                                ...
                                <CardContent className="p-8">
                                    <form onSubmit={handleSubmit} className="space-y-8">
                                        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <Select value={data.store_id} onValueChange={(value) => setData('store_id', value)}>
                                                    <SelectTrigger className="h-14">{errors.store_id ? <span className="text-red-500">Select a store</span> : <SelectValue placeholder="Select a store" />}</SelectTrigger>
                                                    <SelectContent>
                                                        {stores.map((store) => (
                                        ...
                                        <div className="flex flex-col gap-4 pt-6 sm:flex-row">
                                            ...
                                            <Button type="submit" disabled={processing} className="h-14 flex-1">{processing ? 'Creating Report...' : 'Create Report'}</Button>
                                        </div>
                                    </form>
                                </CardContent>
                            </Card>

...
export default function Edit({ auth, store, companies, flash }: EditProps) {
    ...
    return (
        <AppLayout user={auth.user} header={<h2 className="text-xl leading-tight font-semibold text-gray-800">Edit Store</h2>}>
                ...
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            {flash?.message && <div className="mb-4 rounded bg-green-100 p-4 text-green-700">{flash.message}</div>}
